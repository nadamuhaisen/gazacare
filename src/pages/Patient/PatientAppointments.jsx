    ...
    <div className="space-y-6">
      ...
      {appointments.length > 0 ? (
        ...
        <Card className="p-12 text-center flex flex-col items-center justify-center space-y-4">
          <div className="w-16 h-16 rounded-3xl bg-sky-50 dark:bg-sky-950/60 text-sky-600 flex items-center justify-center">
            <Calendar className="w-8 h-8" />
          </div>
          <div className="space-y-1 max-w-sm">
            <h3 className="text-base font-bold text-slate-900 dark:text-white">لا توجد مواعيد محجوزة</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">
              حسابك جديد ولا يحتوي على أي مواعيد سابقة. يمكنك حجز موعد فوري في العيادات الخارجية ومستشفيات القطاع الآن.
            </p>
          </div>
          <Button
            variant="primary"
